...
<center>
<br/><br/>
<h2 style="font-size: 35px;font-weight: bold;font-family: monospace;color: blue;text-decoration: underline;">Delete Users</h2>
<table border=1 style="background: bisque;height: 350px;width: 350px;color: currentColor;font-family: monospace;font-size: 18px;margin-left: 200px;">
<tr>
<th>Uid</th>
<th>Username</th>
<th>First Name</th>
...
<th>Edit</th>
<%
////SHOW DELETE USER OPTION ONLY IF USER HAS DELETE PERMISSIONS
if( pdel == 1){
out.print("<th>Delete User</th>");
}
%>
...
while (rs.next()) {
	...
	////SHOW DELETE USER OPTION ONLY IF USER HAS DELETE PERMISSIONS
	if( pdel == 1){
	out.print("<td><a href=\"dodelete.jsp?uid=" + rs.getString("uid") + "\"> Delete</a></td>");
	}
	out.println("</tr>");
}
%>
