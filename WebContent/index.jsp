...
<center>
<br/><br/><br/><br/><br/>
<h1 style="color: blueviolet;font-family: monospace;font-size: 32px;margin-left: 160px;margin-top: 100px;font-weight: 500;">Hello <strong><%=(String)session.getAttribute("fname")%></strong>! Welcome to your control panel!</h1>
</center>
</body>
</html>